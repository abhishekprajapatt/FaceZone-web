...
//       />
//       {audio ? (
//         <Volume2 className="absolute right-1 mt-[-2.2rem] text-white bg-slate-900 rounded-full p-1" />
//       ) : (
//         <VolumeOff className="absolute right-1 mt-[-2.2rem] text-white bg-slate-900 rounded-full p-1" />
//       )}
...
//               />
//               <h1 className="font-bold"> {postLike > 0 && <>{postLike}</>}</h1>
//             </div>
//           ) : (
//             <div className="flex gap-1">
//               <ThumbsUp
...
//         {text && (
//           <span
//             onClick={() => {commentHandler(); togglecomment();}}
//             className="bg-blue-700 font-mono text-white cursor-pointer rounded-full px-2 py-1 mx-1"
//           >
//             Comment
//           </span>
//         )}
