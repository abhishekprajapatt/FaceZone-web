...
import { ArrowLeft, AtSign, Heart, MessageCircle, UserPlus } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div className="md:hidden mb-10">
        <div className="py-2">
          <h1 className="flex font-bold p- gap-2 fixed py-3 top-0 bg-white w-full">
            <Link to={`/`}><ArrowLeft /></Link>
            <span className="mt-[-0.2rem] text-xl font-serif"> {userProfile?.username}</span>{' '}
          </h1>
          <div className="grid grid-cols-1 my-10">
            <img
              src={
                userProfile?.bannerPicture ||
                'https://compote.slate.com/images/1e6ed0e0-cb79-4a88-91bd-983a58686e19.jpeg?crop=2574%2C1716%2Cx44%2Cy0'
              }
              alt="img"
            ...
            <div className="flex gap-2 px-1">
              <Avatar className="w-28 h-28 border border-2 border-gray-500 mt-[-3rem]">
                ...
                <AvatarFallback>
                  <img
                    src="https://i.pinimg.com/474x/07/cf/97/07cf97356d99cb99415c8ad31cc417bf.jpg"
                    alt=""
                    className=""
                  />
                </AvatarFallback>
          ...
          <div className="flex flex-col gap-5 px-2">
            <div className="flex flex-col gap-1">
              <h1 className="font-bold font-sans">{userProfile?.name || ''}</h1>
              <h1 className="text-gray-600 font-mono text-xs flex">
                <h1>Birthday: </h1>
              ...
              <h1 className="w-2/3 text-sm font-semibold">
                {userProfile?.bio
                  ?.slice(0, 160)
                  ?.match(/.{1,30}/g)
                  ?.slice(0, 20)
            ...
            <div className="">
              {isLoggedInUserProfile ? (
                <div className="flex gap-3">
                  ...
                  <Button variant="secondary" className="w-fit font-semibold px-6">
                    <UserPlus />
                  </Button>
                </div>
              ) : isFollowing ? (
        ...
        <div className="border-t border-t-gray-200">
          ...
          <div className="grid grid-cols-3 gap-1 md:max-w-lg">
      ...
      {/* Desktop */}
      <div className="hidden md:block flex max-w-5xl justify-center mx-auto md:pl-10">
...
const MobileProfile = ({
  ...
  <div className="hidden bg-gradient-to-t from-[#f0a bdc] to-[#88a ae5]">
    <div className="py-2">
      ...
      <div className="grid grid-cols-1">
        <img
          src={
            userProfile?.bannerPicture ||
            'https://www.google.com/url?sa=i&url=https%3A%2F%2F4kwallpapers.com%2Fgames%2Fmarvels-spider-man-2-playstation-5-2021-games-1585.html&psig=AOvVaw14yr1qrth9KFezzKxzbWbZ&ust=1737495296409000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCNCy69WghYsDFQAAAAAdAAAAABAR'
          }
          alt="img"
