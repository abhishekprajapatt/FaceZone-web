...
const Profile = () => {
  ...
  return (
    <div>
            ...
            <section>
              <div className='flex flex-col gap-5'>
                ...
                <div className='flex flex-col gap-1'>
                  <span className='font-semibold w-1/2'>{userProfile?.name || ''}</span>
      ...
      <MobileProfile userProfile={userProfile} isLoggedInUserProfile={isLoggedInUserProfile} isFollowing={isFollowing} activeTab={activeTab}  displayedPost={displayedPost}/>
    </div>
  )
}

const MobileProfile = ({userProfile, isLoggedInUserProfile, isFollowing, activeTab, displayedPost,}) => (
  <div className='flex max-w-5xl justify-center mx-auto md:pl-10'>
      <div className='flex flex-col gap-10 py-8 px-4'>
        <div className="font-serif fixed">{userProfile?.username}</div>
        <div className='grid grid-cols-2 ml-[-3rem] sm:ml-auto'>
          <div className='grid grid-cols-2 items-center justify-center gap-4 mt-[-4rem]'>
            <Avatar className='w-24 h-24 sm:h-32 sm:w-32'>
              <AvatarImage src={userProfile?.profilePicture || "https://th.bing.com/th/id/OIP.YxvEw4Wl6-91Y0v8ntxuMwHaEK?rs=1&pid=ImgDetMain"} alt="profilephoto" />
              <AvatarFallback>CN</AvatarFallback>
            </Avatar>
